<div class="min-h-screen pt-16 pb-12 flex flex-col bg-white">
    <main class="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex-shrink-0 flex justify-center">
            <a href="/" class="inline-flex">
                ...
                <svg class="h-12 w-auto text-pink-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="py-16">
            <div class="text-center">
                <p class="text-sm font-semibold text-pink-600 uppercase tracking-wide">Error</p>
                <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                    <?= htmlspecialchars($title ?? 'Something went wrong') ?>
                </h1>
                <p class="mt-2 text-base text-gray-500">
                    <?= htmlspecialchars($message ?? 'An unexpected error occurred. Please try again later.') ?>
                </p>
                <div class="mt-6">
                    <a href="/" class="text-base font-medium text-pink-600 hover:text-pink-500">
    ...
    <footer class="flex-shrink-0 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex justify-center space-x-4">
            <a href="/contact" class="text-sm font-medium text-gray-500 hover:text-gray-600">
                Contact Support
            </a>
